...
import com.chrishunters.pmba.User;
...
public class JSONServerClient implements Client {
	...
	/* Login the user */
	public void setCredential(String _username, String _password) 
	...
	public void userLogin(String username, String password)
		...
		try
		{
			boolean error = true;
			jso= new JSONObject(result);
			 error = jso.getBoolean("#error");
			 String data = jso.getString("#data");
			if (!error) {
				jso = new JSONObject(data);
				loggedIn = true;
				
				//build the user object from json
				user = new User(new JSONObject(jso.getString("user")));
		...
		{
			//LOG.e("USER_LOGIN_ERROR", e.toString());
		}
	}
